...
SRC_URI="http://www.erlang.org/download/otp_src_R16B02.tar.gz
	http://erlang.org/download/otp_doc_man_R16B02.tar.gz
	doc? ( http://erlang.org/download/otp_doc_html_R16B02.tar.gz )"
